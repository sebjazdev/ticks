...
app_ui = ui.page_fluid(
    ...
    ui.layout_sidebar(
        ...
        ui.markdown("""
                    ...
                    - **GOLD** : 'GC=F', <span style='color: green;'>**'GLD'**</span>, 'IAU', 'BHP', 'RIO' <span style='color: blue;'>(GC=F most widely tracked global benchmark for gold, GLD most actively traded gold ETF globally, IAU lower-cost alternative to GLD, BHP world's largest mining company, RIO australian global mining titan)</span>
                    - **CRYPTO** : 'BTC-USD', 'ETH-USD', 'XRP-USD'
                    - **AI** : 'PLTR', 'OPAI.PVT', 'ANTH.PVT'
                    - **S&P500** : '^GSPC', '^SPX', <span style='color: green;'>**'SPY'**</span>, 'IVV', 'VOO' <span style='color: blue;'>(GSPC & SPX are index non-tradable / cannot buy, SPY [most traded] & IVV & VOO [low expense ratio] are exchange traded funds / ETFs)</span>
                    - **NASDAQ** : '^IXIC', '^NDX', <span style='color: green;'>**'QQQ'**</span>, 'QQQM' <span style='color: blue;'>(IXIC nasdaq composite, NDX nasdaq 100, QQQ & QQQM track NDX)</span>
